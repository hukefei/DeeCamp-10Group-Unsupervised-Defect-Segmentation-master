...
from model.loss.Perceptual_loss import Perceptual_loss
...
class SSIM_Net_PL(nn.Module):
    ...
    def loss(self, input1, input2):
        loss = self.pl(input1, input2)
        return loss

    def res(self, input1, input2):
        res = self.pl.res(input1, input2)
        return res
